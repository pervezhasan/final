...
@section('content')
  ...
  <form action="{{ action('PropertyController@store') }}" method="post" style="width:100%">      
    {{csrf_field()}}
            ...
            <div class="cusom-tools" id="step2" style="display:none; width:100%;">
                ...
                <div class="col-sm-7 mobileOption prettyprint float-left" style="display: none;">
                    <div class="csm">
                        ...
                        <input onclick="showNdiv(); changeColorbg2();" class="form-control" id="footage" name="square_footage" value="" type="text" placeholder="Square Footage" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="fullfom" >
                <h5>Click the types of energy used for these services in year<select name="serviceyear" id="yearsl" class="yearselect"></select>
                    ...
                    <div id="table" class="table-editable show-tab">
                        ...
                        <table id="user" class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            <tbody>
                            <tr>
                                <td></td>
                                <td>Electricity</td>
        ...
        <div class="row" id="tableShow" style="display:none">
                ...
                <div id="table" class="table-editable">
                    <table style="clear: both" class="table table-bordered table-striped" id="user">
                        ...
                        <input style="display:none"  type="text" id="hiddenBoxtext" name="zipcode" value="" />
                        <input style="display:none"  type="text" id="hiddenBoxtext" name="single_or_apartment_or_mobilehome" value="" />
                        <input style="display:none"  type="text" id="hiddenBoxtext" name="single_detached_or_attached" value="" />
                        <input style="display:none"  type="text" id="hiddenBoxtext" name="apartment_2_4_unit_or_5_building" value="" />
