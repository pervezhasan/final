...
<div class="card">
    <div class="card-body">
            ...
            <form method="POST" action="{{ action('VehileController@update', $vehile->id) }} " id="edit_form">  
              <div id="vechile-edit" class="row">  
                  {{ csrf_field() }}
 
                <div class="col-md-3 col-sm-offset-5 pt-4 float-left">
                	<div  class="vechle_modelset">
                        <div id="vechDetails">
                        	<label>Vechile Made By</label>
                            <select name="make" class="select2 m-b-10 select2-hidden-accessible inputactivss" onchange="ShoIyrm();" style="width:100%"  data-placeholder="{{ $vehile->make}}" tabindex="-1"  aria-hidden="true" required>	
                            <option value="{{ $vehile->number_of_vehicle}}" selected="selected">{{ $vehile->make}}</option>
                ...
                <div class="col-md-2 col-sm-offset-5 pt-4 float-left">
                	<div id="yarmodel">
                        	<label>Vechile Model</label>
                               <select name="model" class="select2 m-b-10 select2-hidden-accessible inputactivss" onchange="ShoIyer();" style="width:100%"  data-placeholder="{{ $vehile->moel}}" tabindex="-1"  aria-hidden="true" required>	
                                    <option value="{{ $vehile->number_of_vehicle}}" selected="selected">{{ $vehile->number_of_vehicle}}</option>
                ...
                <div class="col-md-1 col-sm-offset-5 pt-4 float-left">
                    <div id="yearc">
                        <label>Vechile Year</label>
                ...
                <div class="col-md-4 col-sm-offset-5 pt-4 float-left">
                	<div class="col-md-7 col-sm-offset-6 float-left">
                    	<label>Input Power Value</label>
                        <div><input type="text" value="{{ $vehile->powervalue}}" class="form-control" name="powervalue" placeholder="" required /></div>
                    </div>
                    <div class="col-md-5 col-sm-offset-6 float-left">
                    	<label>Set Units</label>
                        <select name="units" class="selectpicker bg-style" title="Units" required="required" >
                ...
                <div class="col-md-2 pt-4 col-sm-offset-9 float-right">
                <label>Miles Driven</label>
                    	<input type="text" value="{{ $vehile->miles_driven}}" class="form-control" name="miles_driven" placeholder=""  required />
                        <input id="vehile_token" type="hidden" name"_token" value="{!! csrf_token() !!}">
                        <input type="hidden" name="_method" value="PATCH">
                    </div>
               </div>
               <div class="row">
                   <div class="col-md-4 pt-4 col-sm-offset-9 float-left">
                   </div>
                    <div class="col-md-4 pt-4 col-sm-offset-9 float-left">
                    	<a href="{{route('vehicle-home')}}" style="background:#fff; display:block; width:100%; cursor:pointer; padding:15px 0; text-align:center; color:green" class="enter-now">Back To Vechiles Page</a>
                    </div>
                    <div class="col-md-4 pt-4 col-sm-offset-9 float-left">
                    	<input style="background:#fff; display:block; width:100%; cursor:pointer; padding:15px 0;" class="enter-now" type="submit" name="submit" value="Update" />
                   </div>
